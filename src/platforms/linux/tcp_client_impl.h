 ...
 * @brief TCP Client Linux Implementation Header
...
#ifndef NETWORK_LINUX_TCP_CLIENT_IMPL_H
#define NETWORK_LINUX_TCP_CLIENT_IMPL_H
...
#endif // NETWORK_LINUX_TCP_CLIENT_IMPL_H