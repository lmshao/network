 ...
 * @brief UDP Server IMPL Implementation
 * @author SHAO L        return static_cast<int>(EventType::read) | static_cast<int>(EventType::ERROR) |
               static_cast<int>(EventType::CLOSE);ing <lmshao@163.com>
